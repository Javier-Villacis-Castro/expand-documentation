...
description: >-
  Aprende cómo añadir el enlace de tu perfil de Expand en la firma de Gmail y
  Outlook para compartir tu tarjeta digital en cada correo.
type: guide
---
## Descripción general
...
<Callout kind="tip" collapsed="false">
  Si tienes problemas para configurar tu firma, utiliza el chat dentro de la plataforma o escribe a: [support@funnel.space](mailto:support@funnel.space)
</Callout>
